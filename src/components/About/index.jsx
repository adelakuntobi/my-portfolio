    ...
    <div className="about">
      <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center w-full lg:w-11/12">
        <div className="">
          ...
          <p className="my-2">I am Adelakun Oluwatobiloba, pretty good with developing, building, and designing web pages, applications across various platforms. </p>
          ...
          <button className="border-transparent hover:border my-6 py-2 greenBtn w-full md:w-5/12">
            <a target="_blank" rel="noopener noreferrer"
             href="https://drive.google.com/file/d/17izRA-ML71j2BuC8Z8qVxPqdjc1hG1fn/view?usp=sharing">
